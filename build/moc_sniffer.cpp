...
#include "../ArpCollector/sniffer.h"
...
QT_MOC_LITERAL(3, 17, 7) // "errored"

    },
    "Sniffer\0updated\0\0errored"
};
...
void Sniffer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Sniffer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sniffer::updated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Sniffer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sniffer::errored)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Sniffer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Sniffer.data,
      qt_meta_data_Sniffer,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Sniffer::updated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Sniffer::errored(QString _t1)
{
